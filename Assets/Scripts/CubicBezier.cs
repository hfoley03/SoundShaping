...
using FLOAT = System.Single;
    ...
    {
        // Control points // USED TO BE READONLY 
        public  VECTOR p0;
        public  VECTOR p1;
        public  VECTOR p2;
        public  VECTOR p3;
        ...
        public override string ToString()
        {
            ...
            sb.Append(", ");
            sb.Append(VectorHelper.GetZ(p0).ToString("#.###", CultureInfo.InvariantCulture));
            sb.Append("> <");
            ...
            sb.Append(", ");
            sb.Append(VectorHelper.GetZ(p1).ToString("#.###", CultureInfo.InvariantCulture));
            sb.Append("> <");
            ...
            sb.Append(", ");
            sb.Append(VectorHelper.GetZ(p2).ToString("#.###", CultureInfo.InvariantCulture));
            sb.Append("> <");
            ...
            sb.Append(", ");
            sb.Append(VectorHelper.GetZ(p3).ToString("#.###", CultureInfo.InvariantCulture));
            sb.Append(">)");
            return sb.ToString();
        }
